      ...
      <div className="ui container" style={{ fontSize: "20px" }}>
        <table className="ui very basic table">
          <tbody className="center aligned">
            ...
            <tr>
              <td>
                <Link to="biddr/auctions/2008">2008</Link>
              </td>
              <td>
                <Link to="biddr/auctions/2012">2012</Link>
              </td>
              <td>
                <Link to="biddr/auctions/2016">2016</Link>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <Link to="biddr/auctions/2017">2017</Link>
              </td>
            </tr>
            <tr>
              <td>
                <Link to="biddr/auctions/2010">2010</Link>
              </td>
              <td>
                <Link to="biddr/auctions/2014">2014</Link>
              </td>
              <td />
            </tr>
          </tbody>
